          ...
          for cmd,priority in self.commandPriorities:
            ...
            # Find steering commad
              if abs(self.chassisCmds[cmd].steering) <= 1.0 and \
                ...
                # Changes max angle from 25 -> 21 (as this is mentioned in xacro file) -JF
                # Also removed negation to make it more straightforward when applying cmds -JF
            ...
            # Find Throttle command
              if abs(self.chassisCmds[cmd].throttle) <= 1.0 and \
                ...
                else: # note throttle is always nonnegative -JF
                  # Shoudn't this be affecting current speed? -JF
                  # something like current_spd - self.rear_axle_brake_effort*...throttle -JF
