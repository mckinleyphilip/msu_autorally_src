...
class AutoRallyCtrlr(object):
  ...
  def getJointStateWheelParams(self, lr_prefix, fr_prefix):
    dia = rospy.get_param(self._vehicle_prefix + "/autorally_controller/"
  ...
  def getLinkStateFrontWheelParams(self, lr_prefix):
    ...
    name = "autorally_platform::" + rospy.get_param(self._vehicle_prefix + "/autorally_controller/"
                               + lr_prefix + "_front_wheel/steering_link_name")
    return name, dia

  def getLinkStateRearWheelParams(self, lr_prefix):
    dia = rospy.get_param("/autorally_platform/" + self._vehicle_prefix + "autorally_controller/"
