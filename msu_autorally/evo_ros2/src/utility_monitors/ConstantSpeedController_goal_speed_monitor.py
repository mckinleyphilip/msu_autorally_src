#!/usr/bin/env python
#
# ConstantSpeedController_goal_speed_monitor
#
#	Monitor node for logging the ConstantSpeedController's goal speed
#
# GAS 2018-08-29
...
class ConstantSpeedController_goal_speed_monitor():
	def __init__(self, cmd_args):
		
		# Init Node
		self.node_name = 'ConstantSpeedController_goal_speed_monitor'
	...
	def set_up_monitored_topic(self):
		topic_name = '/constantSpeedController/speedCommand'
...
if __name__ == '__main__':
	# Parse arguments
	parser = argparse.ArgumentParser(description="Monitor node for logging the ConstantSpeedController's goal speed")
	...
	try:
		node = ConstantSpeedController_goal_speed_monitor(cmd_args = args)
