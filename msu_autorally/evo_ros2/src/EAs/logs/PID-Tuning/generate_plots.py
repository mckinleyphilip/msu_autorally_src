...
class plot_generator():
	...
	def create_run_plots(self):
		...
		ax2.legend(['Actual Speed', 'Error', 'Goal Speed'], bbox_to_anchor=(1.2, 0.8))
		ax2.set_title('Run {} Best Individuals Speed Signal'.format(self.run_number))
		plt.text(0.5, 0.03, 'Mean Squared Error: {}'.format(self.best_fitness), horizontalalignment='center', verticalalignment='center', transform=ax2.transAxes)
		fig2 = ax2.get_figure()
